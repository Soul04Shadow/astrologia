...
const en: Dict = {
  ...
  "dash.title": "People",
  "dash.sub": "Saved birth profiles — open a chart or start a consultation.",
  "dash.add": "New Kundli",
...
const hi: Dict = {
  ...
  "dash.title": "जातक सूची",
  "dash.sub": "सुरक्षित जन्म विवरण — कुंडली खोलें या परामर्श शुरू करें।",
  "dash.add": "नई कुंडली",
